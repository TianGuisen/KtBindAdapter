...
import static tgs.kttool.ToolApplication.toolAppContext;
...
public class RotateLoading extends View {
     ...
     * 圆的颜色
     */
    private int color = Color.parseColor("#FB7299");
    ...
    public int dp2px(int dp) {
        float density = toolAppContext.getResources().getDisplayMetrics().density;
