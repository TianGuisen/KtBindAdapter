...
//*******************************************普通 使用ApplicationContext 方法*********************
    ...
    fun normal(message: String?) {
        normal(toolAppContext, message, Toast.LENGTH_SHORT, null, false)!!.show()
    }

    fun normal(message: String?, icon: Drawable) {
        normal(toolAppContext, message, Toast.LENGTH_SHORT, icon, true)!!.show()
    }

    fun normal(message: String?, duration: Int) {
        normal(toolAppContext, message, duration, null, false)!!.show()
    }

    fun normal(message: String?, duration: Int, icon: Drawable) {
        normal(toolAppContext, message, duration, icon, true)!!.show()
    }

    fun normal(message: String?, duration: Int, icon: Drawable, withIcon: Boolean): Toast? {
        return custom(toolAppContext, message, icon, DEFAULT_TEXT_COLOR, duration, withIcon)
    }

    fun warning(message: String?) {
        warning(toolAppContext, message, Toast.LENGTH_SHORT, true)!!.show()
    }

    fun warning(message: String?, duration: Int) {
        warning(toolAppContext, message, duration, true)!!.show()
    }

    fun warning(message: String?, duration: Int, withIcon: Boolean): Toast {
        return custom(toolAppContext, message, getDrawable(toolAppContext, R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true)
    }

    fun info(message: String?) {
        info(toolAppContext, message, Toast.LENGTH_SHORT, true)!!.show()
    }

    fun info(message: String?, duration: Int) {
        info(toolAppContext, message, duration, true)!!.show()
    }

    fun info(message: String?, duration: Int, withIcon: Boolean): Toast {
        return custom(toolAppContext, message, getDrawable(toolAppContext, R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true)
    }

    fun success(message: String?) {
        success(toolAppContext, message, Toast.LENGTH_SHORT, true)!!.show()
    }

    fun success(message: String?, duration: Int) {
        success(toolAppContext, message, duration, true)!!.show()
    }

    fun success(message: String?, duration: Int, withIcon: Boolean): Toast {
        return custom(toolAppContext, message, getDrawable(toolAppContext, R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true)
    }

    fun error(message: String?) {
        error(toolAppContext, message, Toast.LENGTH_SHORT, true)!!.show()
    }
...
//*******************************************常规方法********************************************
    ...
    fun error(message: String?, duration: Int) {
        error(toolAppContext, message, duration, true)!!.show()
    }

    fun error(message: String?, duration: Int, withIcon: Boolean): Toast {
        return custom(toolAppContext, message, getDrawable(toolAppContext, R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true)
    }
